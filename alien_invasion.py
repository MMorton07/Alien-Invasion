...
class AlienInvasion:
	...
	def _update_bullets(self):
		"""Update the position of bullets and get rid of the old bullets when they fly off the screen."""
		self.bullets.update()
	...
	def _check_fleet_edges(self):
		"""Respond appropriately if any aliens have reached an edge on the screen."""
	...
	def _update_screen(self):
		#update images on the screen during  each pass through the loop. Fill the background with this new color.
